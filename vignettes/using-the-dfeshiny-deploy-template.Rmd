...
- Register for an API key on the [Carto website](https://carto.com/basemaps/apikey/)
...
- Add the key to any code where using Carto maps following the example below:
