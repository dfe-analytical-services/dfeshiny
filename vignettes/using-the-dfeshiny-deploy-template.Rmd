...
- Add that key as an environment secret for your GitHub repo (settings > Secrets and variables > Actions). You can use whatever name you want, but we've used `CARTO_API_TOKEN` in the example below (`secrets.CARTO_API_TOKEN`).
