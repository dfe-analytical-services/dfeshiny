...
Create the server module of DfE R-Shiny cookies dashboard panel to be
used alongside cookies_panel_ui().
...
- id:
  ...
  Shiny tag shared with cookies_panel_ui(), can be any string set by the
  user as long as it matches the id in the cookies_panel_ui()
