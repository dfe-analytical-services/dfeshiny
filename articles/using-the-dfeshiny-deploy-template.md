...
1.  **Have a `deploy_parameters.yaml`**: Store all your deployment
    parameters, including the app name and deployment target.
...
- **Reduces complexity** of dashboards deployments - you only maintain a
...
all your deployment logic in a single, centralized workflow template.
